...
int main(int argc, char** argv){
	...
	// uint16_t instr = 0x800a; //BPL 0x0A
	// uint16_t instr = 0x0000; //HALT
	// uint16_t instr = 0x0001; //WAIT
	// uint16_t instr = 0x0005; //RESET
	// uint16_t instr = 0x00a0; //NOP
	uint16_t instr = 0xFFFF; //UNDEFINED ASM
